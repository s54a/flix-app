(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(i){if(i.ep)return;i.ep=!0;const n=t(i);fetch(i.href,n)}})();const s={currentPage:window.location.pathname,search:{term:"",type:"",page:1,total_pages:1,total_results:0},api:{API_URL:void 0,API_KEY:void 0}};async function v(){const{results:a}=await o("movie/popular");a.forEach(e=>{const t=document.createElement("div");t.classList.add("card"),t.innerHTML=`
          ...
          `,document.querySelector("#popular-shows").appendChild(t)})}async function f(){const a=window.location.search.split("=")[1],e=await o(`movie/${a}`);u("movie",e.backdrop_path);const t=document.createElement("div");t.innerHTML=`
  ...
  `,document.querySelector("#movie-details").appendChild(t)}async function $(){const a=window.location.search.split("=")[1],e=await o(`tv/${a}`);u("tv",e.backdrop_path);const t=document.createElement("div");t.innerHTML=`
  <div class="details-top">
          <div>
          ${e.poster_path?`<img
                src="https://image.tmdb.org/t/p/w500${e.poster_path}"
