(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(i){if(i.ep)return;i.ep=!0;const n=t(i);fetch(i.href,n)}})();const s={currentPage:window.location.pathname,search:{term:"",type:"",page:1,total_pages:1,total_results:0},api:{API_URL:"https://api.themoviedb.org/3/",API_KEY:"034762d6f969bde75ad8302b2c2e63a5"}};async function y(){const{results:a}=await o("movie/popular");a.forEach(e=>{const t=document.createElement("div");t.classList.add("card"),t.innerHTML=`
          ...
          `,document.querySelector("#popular-movies").appendChild(t)})}async function v(){const{results:a}=await o("tv/popular");a.forEach(e=>{const t=document.createElement("div");t.classList.add("card"),t.innerHTML=`
  ...
  `,document.querySelector("#pagination").appendChild(a),s.search.page===1&&(document.querySelector("#prev").disabled=!0),s.search.page===s.search.total_pages&&(document.querySelector("#next").disabled=!0),document.querySelector("#prev").addEventListener("click",async()=>{s.search.page--;const{results:e}=await d();l(e)}),document.querySelector("#next").addEventListener("click",async()=>{s.search.page++;const{results:e}=await d();l(e)})}async function b(){const{results:a}=await o("movie/now_playing");a.forEach(e=>{const t=document.createElement("div");t.classList.add("swiper-slide"),t.innerHTML=`
    ...
    `,document.querySelector(".swiper-wrapper").appendChild(t),S()})}function S(){new Swiper(".swiper",{slidesPerView:1,spaceBetween:30,freeMode:!0,loop:!0,autoplay:{delay:4e3},breakpoints:{500:{slidesPerView:2},700:{slidesPerView:3},1200:{slidesPerView:4}}})}function L(a){const e=document.querySelector(".mainContainer");e.innerHTML="";const t=document.createElement("div");t.style.display="flex",t.style.justifyContent="center",t.style.alignItems="center",t.style.minHeight="100vh",t.style.width="100%",t.style.position="fixed",t.style.top="0",t.style.left="0",t.style.backgroundColor="rgba(0, 0, 0, 0.8)",t.innerHTML=`
    <div class="container">
  ...
  `,e.appendChild(t)}async function o(a){const e=s.api.API_KEY,t=s.api.API_URL;g();try{const i=await(await fetch(`${t}${a}?api_key=${e}&language=en-US`)).json();return p(),i}catch{L("API Error while fetching data from TMDB API. OR You are in India and I don't know why the TMDB API is blocked in India so please use a VPN to access the Website."),p();return}}async function d(){const a=s.api.API_KEY,e=s.api.API_URL;g();const r=await(await fetch(`${e}search/${s.search.type}?api_key=${a}&language=en-US&query=${s.search.term}&page=${s.search.page}`)).json();return p(),r}function g(){document.querySelector(".spinner").classList.add("show")}function p(){document.querySelector(".spinner").classList.remove("show")}function P(){document.querySelectorAll(".nav-link").forEach(e=>{e.getAttribute("href")===s.currentPage&&e.classList.add("active")})}function m(a){return a.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")}function u(a,e="error"){const t=document.createElement("div");t.classList.add("alert",e),t.appendChild(document.createTextNode(a)),document.querySelector("#alert").appendChild(t),setTimeout(()=>t.remove(),3e3)}function x(){switch(s.currentPage){case"/":case"/index.html":b(),y();break;case"/shows.html":v();break;case"/movie-details.html":f();break;case"/tv-details.html":$();break;case"/search.html":w();break}P()}document.addEventListener("DOMContentLoaded",()=>{x()});
